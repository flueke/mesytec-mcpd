...
set MCPD_ADDRESS=192.168.168.221
set MCPD_ID=0

:: For MCPD-8_v2 which can use DHCP
::set MCPD_ADDRESS=mcpd-0029
::set MCPD_ID=0
...
:: Assumes the MPSD is plugged into bus 2 of the MCPD. Setup the MPSD to send
:: out pulser data for channel 3.
...
mcpd-cli readout --no-listfile --print-packet-summary --print-event-data --duration 120
